...
export const DUMPSTER_SIZES: DumpsterSizeOption[] = [
  ...
  {
    id: "20-yard-rubber",
    label: "20 Yard (Rubber-Tired)",
    units: 3,
    oneDayPrice: 350,
    threeDayPrice: 400,
    weeklyPrice: 450,
    perfectFor: ["Major renovations", "Commercial jobs", "Driveways & pavers"],
    includes: [
      `${INCLUDED_TONS} ton capacity`,
      "Flexible rental terms",
      "Rubber tires — won't scratch or mark concrete",
    ],
  },
  {
    id: "20-yard-trailer",
